...
public Gold() {
	...
	JFrame goldWindow = new JFrame("Gold Plan");
	goldWindow.setLayout(new GridLayout(1,3));
	goldWindow.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
...
//Create the billing option buttons	
	JButton pif1 = new JButton("Gold 1 Yr PIF");
	JButton pif3 = new JButton("Gold 3 Yr PIF");
	JButton month1 = new JButton("Gold 1 Yr Monthly");
	JButton month3 = new JButton("Gold 3 Yr Monthly");
...
//Add all components to frame
	goldWindow.add(top);
	goldWindow.add(middle);
	goldWindow.add(bottom);

	goldWindow.pack();
	goldWindow.setLocationRelativeTo(null);
