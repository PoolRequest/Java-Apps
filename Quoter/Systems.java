...
public Systems() {
	...
	JFrame silverWindow = new JFrame("Systems Plan");
...
//Create the billing option buttons	
	JButton pif1 = new JButton("Systems 1 Yr PIF");
	JButton pif3 = new JButton("Systems 3 Yr PIF");
	JButton month1 = new JButton("Systems 1 Yr Monthly");
	JButton month3 = new JButton("Systems 3 Yr Monthly");
